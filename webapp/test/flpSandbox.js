		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GitHub Api UI5",
									"targetURL": "#githubapiui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"githubapiui5-display": {
								"semanticObject": "githubapiui5",
								"action": "display",
								"description": "An app that retrieves and displays the repositories an organisation of a GitHub user",
								"title": "GitHub Api UI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=githubapiui5",
									"url": sap.ui.require.toUrl("githubapiui5")
								}
							}
						}
					}
